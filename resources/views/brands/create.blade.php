                        ...
                        <form class="needs-validation" novalidate="" action="{{route('brands.store')}}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="validationCustom02" value="{{old('company_name')}}" name="company_name" type="text"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="js-example-placeholder-multiple col-sm-8 form-control" value="{{old('country')}}" id="counrty"
                                        name="country">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="js-example-placeholder-multiple col-sm-8 form-control" value="{{old('status')}}" id="status"
