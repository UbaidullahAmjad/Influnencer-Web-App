	...
	<div class="row">
		<div class="col-sm-12">
            ...
            <div class="container">
					...
					<form class="needs-validation" novalidate="" action="{{ route('coupon.store') }}" method="post" enctype="multipart/form-data">
					@csrf
						<div class="row">
    ...
    @endif
                  ...
                  @endif
                              ...
                              <p style="font-weight: bold;font-size: 15px;">Select Brand *</p>
                                 ...
                                 <option value="" disabled selected>Select Brand</option>
									...
									<div class="col-md-4 mb-3">
										...
										<input class="form-control" id="validationCustom01" value="{{old('coupon_code')}}" name="coupon_code" type="text" placeholder="Coupon Code">
                           ...
                           <div class="col-md-4 mb-3">
										...
										<!-- <div class="col-form-label">Amount</div> -->
                              <input class="form-control" id="amount" value="{{old('amount')}}" name="amount" min="1" type="number" placeholder="Amount">
										<!-- <div class="valid-feedback">Looks good!</div> -->
