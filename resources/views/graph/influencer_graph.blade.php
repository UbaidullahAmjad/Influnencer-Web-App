    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-xl-12 box-col-12">
            <div class="card">
                ...
                <form class="needs-validation search_form" novalidate="" action="{{route('influencer.search_data')}}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" step="any" name="comm_before" class="form-control"
                        ...
                        <div class="col-md-3 mb-2">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">%</span>
                                <input type="number" step="any" name="comm_after" class="form-control"
                                    aria-label="Username" aria-describedby="basic-addon1">
                            </div>
