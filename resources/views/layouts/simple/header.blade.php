      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          <div class="media profile-media">
            ...
            <div class="media-body">
              <span>{{!empty(auth()->user()) ? auth()->user()->f_name : ''}}</span>
              <p class="mb-0 font-roboto">{{ (!empty(auth()->user()) && auth()->user()->user_type == 2) ? 'Influencer' : 'Admin'}} <i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
