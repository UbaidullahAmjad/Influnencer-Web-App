								...
								<div class="col-md-4">
											 <p style="font-weight: bold;font-size: 15px;">Sale Amount</p>
											    <div class="input-group mb-3">
                                                       ...
                                                       <input class="form-control"  value="{{$management->sales_amount_usd}}" aria-label="Amount (to the nearest dollar)" name="sale_amount_usd" type="number" placeholder="Sale Amount"  step="any">
                                                   </div>
                                                 </div>
