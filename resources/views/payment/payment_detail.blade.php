                        ...
                        <div class="card-body">
                            <div class="container">
                                    ...
                                    <div class="table-responsive product-table" id="data-table" style="display:none;">
                                        <div class="row mb-5">
                                            <div class="col-lg-9">
                                            <form action="{{ route('search_payments') }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                                <div class="row mb-5">
                                                    <div class="col-lg-11">
                                                        <input type="text" name="search" class="form-control" value="{{ isset($search) ? $search : '' }}" placeholder="Search Payments By Publisher ID, Bank or IBAN">
                                                    </div>
                                                    <div class="col-lg-1">
                                            ...
                                            <div class="col-lg-1"></div>
                                            <div class="col-lg-2">
                                                <a class="btn btn-primary" href="{{ route('export-payments') }}">Export</a>
                                            </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @foreach($payments as $payment)
                                                                            <tr>
                                                                                ...
                                                                                <div class="col-md-3">
                                                                                    <select name="transfer" id="transfer_{{$payment->id}}">
                                                                                        <option value="1" {{ $payment->transfer == 1 ? 'selected' : '' }}>Transfer</option>
                                                                                        <option value="0" {{ $payment->transfer == 0 ? 'selected' : '' }}>Not Transfer</option>
                                                                                    </select>
                                                                                    <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
                                                                                    <script>
                                                                                        // var id = "";
                                                                                        $('#transfer_{{ $payment->id }}').on('change', function() {
                                                                                            var val = this.value;
