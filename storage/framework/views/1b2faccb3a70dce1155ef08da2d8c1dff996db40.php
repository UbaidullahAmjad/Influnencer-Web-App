                        ...
                        <div class="card-body">
                            <div class="container">
                                <div class="d-flex flex-row-reverse mb-3">
                                    <a class="p-1" href="<?php echo e(route('csv_brands')); ?>"><button
                                            class="btn btn-primary">CSV</button></a>
                                    <a class="p-1" href="<?php echo e(route('brand.export')); ?>"><button
                                            class="btn btn-warning">Export</button></a>
                                    <a class="p-1" href="<?php echo e(route('brands.create')); ?>"><button
                                            class="btn btn-success">Add</button></a>

                                    <button style="margin-bottom: 10px" class="btn btn-danger delete_all mt-1"
                                        data-url="<?php echo e(url('myproductsDeleteAll')); ?>">Bulk Delete</button>
                                ...
                                <div class="row">
                                    ...
                                    <!-- <div class="col-lg-8">
                                    <form action="<?php echo e(route('search_brands')); ?>" method="post" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        <div class="row mb-5">
                                            <div class="col-lg-11">
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\influencer_app\resources\views/brands/index.blade.php ENDPATH**/ ?>