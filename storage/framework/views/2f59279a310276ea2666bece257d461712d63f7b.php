								...
								<div class="col-md-4">
											 <p style="font-weight: bold;font-size: 15px;">Sale Amount</p>
											    <div class="input-group mb-3">
                                                       ...
                                                       <input class="form-control"  value="<?php echo e($management->sales_amount_usd); ?>" aria-label="Amount (to the nearest dollar)" name="sale_amount_usd" type="number" placeholder="Sale Amount"  step="any">
                                                   </div>
                                                 </div>
...
<?php endif; ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\influencer_app\resources\views/management/marketer_edit.blade.php ENDPATH**/ ?>