...
<div class="container-fluid">
    ...
    <?php endif; ?>
					<form class="needs-validation" action="<?php echo e(route('csv_upload')); ?>" method="post" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>
						<div class="row">
...
<?php endif; ?>
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\influencer_app\resources\views/influencer/csv_influencer.blade.php ENDPATH**/ ?>