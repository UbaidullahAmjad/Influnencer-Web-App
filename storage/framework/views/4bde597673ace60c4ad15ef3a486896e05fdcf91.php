                        ...
                        <div class="card-body">
                            <div class="container">
                                <div class="d-flex flex-row-reverse mb-3">
                                    <a class="p-1" href="<?php echo e(route('assciate_csv')); ?>"><button
                                            class="btn btn-primary">CSV</button></a>
                                    <a class="p-1" href="<?php echo e(route('assciate_csv_export')); ?>"><button
                                            class="btn btn-warning">Export</button></a>
                                    <a class="p-1" href="<?php echo e(route('assciate.create')); ?>"><button
                                            class="btn btn-success">Add</button></a>
                                    <button style="margin-bottom: 10px" class="btn btn-danger delete_all mt-1"
                                        data-url="<?php echo e(url('myassociateDeleteAll')); ?>">Bulk Delete</button>
    ...
    <?php $__env->startSection('script'); ?>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('assciate.index')); ?>",
                columns: [
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\influencer_app\resources\views/association/index.blade.php ENDPATH**/ ?>