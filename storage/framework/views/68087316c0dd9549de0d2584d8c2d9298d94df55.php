                        ...
                        <div class="card-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <form action="<?php echo e(route('management_csv_export')); ?>" method="Post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                                    <div class="row">
                                                        <div class="col-lg-8">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="d-flex flex-row-reverse mb-3">
                                            <a class="p-1" href="<?php echo e(route('management_csv')); ?>"><button
                                                    class="btn btn-primary">CSV</button></a>
                                            <!-- <a class="p-1" href="<?php echo e(route('management_csv_export')); ?>"><button
                                                    class="btn btn-warning">Export</button></a> -->
                                            
                                            <button style="margin-bottom: 10px" class="btn btn-danger delete_all mt-1"
                                                data-url="<?php echo e(url('myuploadDeleteAll')); ?>">Bulk Delete</button>
    ...
    $('.alert-danger').fadeOut('fast');
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(route('management.index')); ?>",
                columns: [
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\influencer_app\resources\views/management/index.blade.php ENDPATH**/ ?>