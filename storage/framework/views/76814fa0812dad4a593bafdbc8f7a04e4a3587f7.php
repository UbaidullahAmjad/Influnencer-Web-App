      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown p-0 me-0">
          <div class="media profile-media">
            ...
            <div class="media-body">
              <span><?php echo e(!empty(auth()->user()) ? auth()->user()->f_name : ''); ?></span>
              <p class="mb-0 font-roboto"><?php echo e((!empty(auth()->user()) && auth()->user()->user_type == 2) ? 'Influencer' : 'Admin'); ?> <i class="middle fa fa-angle-down"></i></p>
            </div>
          </div>
          <ul class="profile-dropdown onhover-show-div">
            ...
            <li><a href="<?php echo e(route('logout')); ?>"><i data-feather="log-in"> </i><span>Logout</span></a></li>
          </ul>
        </li>
      </ul>
    </div>
...
<?php /**PATH C:\xampp\htdocs\influencer_app\resources\views/layouts/simple/header.blade.php ENDPATH**/ ?>